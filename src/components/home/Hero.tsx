        ...
        <div className="flex flex-col lg:flex-row items-center gap-10 lg:gap-16">
          <div className="lg:w-1/2 text-center lg:text-left">
            ...
            <p className="text-xl md:text-2xl text-foreground/80 mb-10 max-w-2xl mx-auto lg:mx-0">
              Transforme sua prática clínica com uma plataforma que conecta
              profissionais e pacientes através de um monitoramento emocional
              intuitivo e humano.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              ...
              <Button
                variant="outline"
                className="px-6 py-6 border-mint-500 text-mint-700 hover:bg-mint-50 rounded-full text-lg"
              >
                Fale conosco
              </Button>
            </div>
                ...
                <div className="grid grid-cols-7 gap-2 mb-8">
                  {Array.from({ length: 7 }).map((_, i) => (
                    <div key={i} className="flex flex-col items-center">
                      ...
                      <div
                        className={`h-24 w-full bg-white rounded-lg border ${
                          i === 3
                            ? "border-sky-300"
                            : i === 5
                              ? "border-mint-300"
